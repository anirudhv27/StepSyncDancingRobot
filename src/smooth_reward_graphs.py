...
rewards = np.load('tuning/rewards/small_reward_mujoco_a2c.npy')
timesteps = np.load('tuning/timesteps/small_reward_mujoco_a2c.npy')
...
axs[0].set_title('Sliding Average of Average Reward per episode (Survival Reward = 0.5, A2C)')
axs[0].set_xlabel('Episode')
...
axs[1].set_title('Sliding Average of Total Reward per episode (Survival Reward = 0.5, A2C)')
...
axs[2].set_title('Sliding Average of Total Reward per episode (Survival Reward = 0.5, A2C)')
